  ...
  return (
    <main className="min-h-screen bg-[var(--bg-alt)] py-24">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-8">{t('datenschutz_title')}</h1>
        <div className="bg-white rounded-2xl border border-[var(--border)] p-8 shadow-sm">
          ...
          <a
            href="/legal-placeholders/datenschutz.pdf"
            ...
            aria-label="Datenschutzerklärung als PDF herunterladen"
          >
