        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <a href={telHref(data.telefon)} className="text-sm text-gray-300 hover:text-white transition-colors flex items-center gap-2">
              ...
              <li>
                <a href={`mailto:${data.email}`} className="text-sm text-gray-300 hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4 text-[var(--teal-400)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
